...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/arvind0251/NYKAAXBOT",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv(
    "GIT_TOKEN", None)  # Fill this variable if your upstream repository is private

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/ROC_KY098")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/ROC_KY098")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/61e70ff4ed9141709cba9.jpg"
)
PING_IMG_URL = getenv(
